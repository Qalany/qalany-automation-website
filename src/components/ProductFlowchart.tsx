...
const ProductFlowchart = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative bg-muted/30 rounded-3xl p-8 md:p-12 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="grid md:grid-cols-4 gap-6 md:gap-4">
            {steps.map((step, index) => (
              <div key={step.title} className="relative">
                ...
                {/* Step card */}
                <div className="group relative bg-card rounded-2xl p-6 shadow-elevated border border-border/50 hover:shadow-3d transition-all duration-500 hover:-translate-y-2 h-full">
                  {/* Step number */}
                  <div className="absolute -top-3 -left-3 w-8 h-8 rounded-full bg-primary flex items-center justify-center shadow-lg">
                  ...
                  {/* Icon */}
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center mb-4 group-hover:from-primary/20 group-hover:to-primary/10 transition-all duration-300">
          ...
          <div className="mt-12 bg-card rounded-2xl p-6 shadow-card border border-border/50">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 py-6">
              ...
              <div className="flex flex-col items-center">
                <div className="w-20 h-20 rounded-xl bg-primary/10 border-2 border-primary/30 flex items-center justify-center">
                  <span className="text-xs font-semibold text-primary text-center px-1">
                    New Lead
                  </span>
                </div>
